<div id="site">
  <div id="content_2_column">
    <?php $this->load->view('admin/ac/sub_menu'); ?>
              ...
              foreach ($ac_chart_list as $key => $value) {
                ...
                <tr <?php if ($i == 1) { ?>class="RowStyle"<?php } else { ?>class="AlternatingRowStyle"<?php } ?>>
                  <td align="center" style="height: 22px;">
                    <a href="accounts/edit_chart_ac/<?php echo $value['id']; ?>?height=250&width=400&modal=true" class="thickbox" title="Chart of A/C Edit"><img src="images/icon_edit.gif" border="0" /></a>
                    <a href="accounts/delete_chart_ac/<?php echo $value['id']; ?>" title="Chart of A/C Delete"><img src="images/icon_delete.gif" class="delete" border="0" /></a>
                  </td>
