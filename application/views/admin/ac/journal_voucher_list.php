  ...
  <div id="content_2_column">
    ...
    <div id="channel_full">
      <div id="manager_header">
        <h1 id="lblPageName">Journal Voucher List</h1>
      </div>
              ...
              foreach ($journal_vouchers as $key => $value) {
                ...
                <tr <?php if ($i == 1) { ?>class="RowStyle"<?php } else { ?>class="AlternatingRowStyle"<?php } ?>>
                  <td align="center" style="height: 22px;">
                    <a href="accounts/edit_journal_voucher_master/<?php echo $value['id']; ?>" title="Item Edit"><img src="images/icon_edit.gif" border="0" /></a>
                    <input type="hidden" value="<?php echo $value['id']; ?>" /><img src="images/icon_delete.gif" class="delete" style="cursor: pointer;" border="0" />
                  </td>
