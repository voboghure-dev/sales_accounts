  ...
  <div id="content_2_column">
    ...
    <div id="channel_full">
      <div id="manager_header">
        <h1 id="lblPageName">Debit Voucher List</h1>
      </div>
              ...
              foreach ($debit_vouchers as $key => $value) {
                ...
                <tr <?php if ($i == 1) { ?>class="RowStyle"<?php } else { ?>class="AlternatingRowStyle"<?php } ?>>
                  <td align="center" style="height: 22px;">
                    <a href="accounts/edit_debit_voucher_master/<?php echo $value['id']; ?>" title="Item Edit"><img src="images/icon_edit.gif" border="0" /></a>
                    <a href="accounts/delete_debit_voucher/<?php echo $value['id']; ?>" title="Item Delete"><img src="images/icon_delete.gif" class="delete" border="0" /></a>
                  </td>
