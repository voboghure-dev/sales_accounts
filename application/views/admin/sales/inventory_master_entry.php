  ...
  <div id="content_2_column">
    ...
    <div id="channel_full">
      <div id="manager_header">
        <h1 id="lblPageName">Inventory Master Entry</h1>
      </div>
      ...
      <div id="ManagerWorkArea">
        <div style="overflow: scroll;" id="mgrFullChannel">
          <?php echo form_open('sales_setup/inventory_master_add', 'name="inventory_master" id="inventory_master"'); ?>
          <table cellspacing="0" border="0" style="border-collapse: collapse;" id="gvItemList" class="GridView">
            <tbody>
              ...
              <tr>
                ...
                <td><input name="inventory_no" value="<?php echo $inventory_no; ?>" style="width: 230px;" /></td>
                <td><strong>Inventory Date</strong></td>
                <td><input type="text" class="jq_date" name="inventory_date" value="<?php echo date('Y-m-d'); ?>" style="width: 230px;" /></td>
              </tr>
              <tr>
                <td class="first" valign="top"><strong>Notes</strong></td>
                <td class="last" colspan="3"><textarea name="notes" style="width: 620px;"></textarea></td>
              </tr>
              <tr>
