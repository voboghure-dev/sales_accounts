  ...
  <div id="content_2_column">
    ...
    <div id="channel_full">
      <div id="manager_header">
        <h1 id="lblPageName">Purchase Master Entry</h1>
      </div>
      ...
      <div id="ManagerWorkArea">
        <div style="overflow: scroll;" id="mgrFullChannel">
          <?php echo form_open('sales_setup/purchase_master_add', 'name="purchase_master" id="purchase_master"'); ?>
          <table cellspacing="0" border="0" style="border-collapse: collapse;" id="gvItemList" class="GridView">
            <tbody>
              ...
              <tr>
                ...
                <td><input name="purchase_no" value="<?php echo $purchase_no; ?>" style="width: 230px;" /></td>
                <td><strong>Purchase Date</strong></td>
                <td><input type="text" class="jq_date" name="purchase_date" value="<?php echo date('Y-m-d'); ?>" style="width: 230px;" /></td>
              </tr>
              <tr>
