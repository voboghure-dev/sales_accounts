...
<div>
  ...
  <?php echo form_open('sales_setup/customer_edit'); ?>
  <table width="100%" border="0" cellpadding="5" cellspacing="5">
    <tr>
      <td><b>Code :</b></td>
      <td><input type="text" name="code" style="width: 350px;" value="<?php echo $customer['code']; ?>" /></td>
    </tr>
    <tr>
      <td><b>Full Name :</b></td>
      <td><input type="text" name="name" style="width: 350px;" value="<?php echo $customer['name']; ?>" /></td>
    </tr>
    <tr>
      <td valign="top"><b>Address :</b></td>
      <td><textarea name="address" style="width: 350px;"><?php echo $customer['address']; ?></textarea></td>
    </tr>
    <tr>
      <td><b>City :</b></td>
    ...
    <tr>
      <td><b>Mobile :</b></td>
      <td><input type="text" name="mobile" style="width: 350px;" value="<?php echo $customer['mobile']; ?>" /></td>
    </tr>
    <tr>
      <td><b>Phone :</b></td>
    ...
    <tr>
      ...
      <td><input type="text" name="dob" class="jq_date" style="width: 150px;" value="<?php echo $customer['dob']; ?>" />&nbsp;[ year-month-day ]</td>
    </tr>
    <tr>
      <td><b>Web Site :</b></td>
      <td><input type="text" name="web" style="width: 350px;" value="<?php echo $customer['web']; ?>" /></td>
    </tr>
    <tr>
